...
const Testimonials = ({forwardedRef, isVisible}) => (
  <section id="clients" className={`${styles.paddingY} ${styles.flexCenter} flex-col relative `}>
    ...
    <div ref={forwardedRef} className="flex flex-wrap sm:justify-start justify-center w-full feedback-container relative z-[1]">
    {feedback.map((card) => <FeedbackCard visible={isVisible} key={card.id} {...card} />)}
    </div>
  </section>
);
