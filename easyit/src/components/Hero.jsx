...
import { discount, robot, cuboPequeno, easyitgif } from '../assets';
...
const Hero = () => (
    ...
    ${styles.paddingY}`}>
      ...
      <div id="LeftSide" className={`flex-1  ${styles.flexStart} flex-col xl:px-0 sm:px-16 px-6`}>
        ...
        <div className='flex flex-row justify-between items-center w-full'>
          <h1 className='flex-1 font-poppins font-semibold ss:text-[52px] text-[42px] text-white ss:leading-[70px]
          leading-[75px]'>
        ...
        <h1 className='font-poppins font-semibold ss:text-[52px] text-[52px] text-white ss:leading-[70px]
      ...
      <div id="RightSide" className={`flex-1 flex ${styles.flexCenter} md:my-0 my-10 relative `}>
        <img src={easyitgif} alt="billing" className='opacity-70 rounded-l-lg w-[100%] h-[100%] relative z-[5] lg:w-[100%] lg:h-[100%] md:w-[100%] md:h-[80%] sm:flex hidden'/>
